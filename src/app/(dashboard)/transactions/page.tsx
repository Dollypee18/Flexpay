...
export default function TransactionsPage() {
  ...
  const cellStyle = { fontSize: "13px", color: "#F0F0F0" };
  const mutedStyle = { fontSize: "12px", color: "#888888" };
            ...
            paginated.map((txn, index) => (
              <div
                ...
                style={{
                  ...
                  padding: "14px 20px",
                  borderBottom:
                    index < paginated.length - 1 ? "1px solid #2A2A2A" : "none",
                  alignItems: "center",
                }}
              >
                <div
                ...
                >
                  ...
                  <p style={cellStyle}>{txn.description}</p>
                </div>
                <p
                  style={{
                    ...cellStyle,
                ...
                <p style={mutedStyle}>{formatDate(txn.createdAt)}</p>
              </div>
            ))
          )}
        </div>
